...
# global rank is the rank of the process in the MPI_COMM_WORLD
global_rank = 0

# local rank is the rank of the process in the node (used as GPU device id)
local_rank = pc.utilities.get_local_rank()
try:
...
if global_rank == 0:
    ...
    fig.savefig("lmecce.png", dpi=300)
